...
from .handlers.graph_handlers import GraphSearchHandler, GraphExpandHandler, NodePayloadHandler
...
def make_app(data_dir: str = "/workspace/data") -> tornado.web.Application:
	...
	metadata_service = MetadataService(data_dir)
	payload_registry = PayloadProviderRegistry(store, data_dir)
	return tornado.web.Application([
		...
		(r"/metadata/types", MetadataHandler, {"metadata_service": metadata_service}),
		(r"/graph/search", GraphSearchHandler, {"graph_service": graph_service}),
		(r"/graph/expand", GraphExpandHandler, {"graph_service": graph_service}),
		(r"/node/([\w\-\.:]+)", NodePayloadHandler, {"payload_registry": payload_registry}),
